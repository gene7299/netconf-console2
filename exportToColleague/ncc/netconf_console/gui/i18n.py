...
_EN_EXACT = {
    ...
    "連線系統 SSH": "Connect system SSH", "中斷 SSH": "Disconnect SSH", "系統SSH": "System SSH",
    ...
    "從最新備份還原 running": "Restore running from latest backup", "備份 / 還原": "Backup / Restore",
    ...
    "尚未執行；備份使用 UTC 時間目錄，還原會自動找最新並驗證 SHA256。": "Not run yet; backups use UTC timestamped folders, and restore finds the latest and verifies SHA256 automatically.",
